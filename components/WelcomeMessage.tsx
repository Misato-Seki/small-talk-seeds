export default function WelcomeMessage({ onFinish }: { onFinish: () => void }) {
  return (
    <div
      className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center outline-primary outline-2 rounded-lg p-4 mb-4 bg-white w-1/2 h-1/2 animate-[frame-fade-in-out_var(--welcome-duration)_ease-in-out_forwards]"
      onAnimationEnd={(e) => {
